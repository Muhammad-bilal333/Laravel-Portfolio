...
<script>
    ...
    $(document).ready(function() {
        ...
        document.querySelectorAll('form[action*="delete.QualityEnhancementCell"]').forEach(form => {
            form.addEventListener('submit', function(e) {
                e.preventDefault();
                if (confirm('Are you sure you want to delete this QEC member? This action cannot be undone.')) {
                    this.submit();
                }
            });
        });
        ...
        const tableBody = document.getElementById('qec-table-body');
